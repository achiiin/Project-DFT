# -*- coding: utf-8 -*-
"""
Created on Thu Mar 05 17:41:34 2015
...
start = time.time()
list_SMILES = []
list_SMILES = ['c1ccccc1', 'c1cccs1', '[SiH2]1C=CC=C1', 'c1ccc[se]1', 'c1ccc[nH]1',
...
list_smart = ['[#6]~1~[#6]~[#6]~[#6]~[#6]~[#6]~1','s~1~[#6]~[#6]~[#6]~[#6]~1','[SiH2r5]','[se]~1~[#6]~[#6]~[#6]~[#6]~1','[nH]~1~[#6]~[#6]~[#6]~[#6]~1', #1~5
...
saveDict('BuildingBlocks_relaitonship.csv',dic_numbb)
